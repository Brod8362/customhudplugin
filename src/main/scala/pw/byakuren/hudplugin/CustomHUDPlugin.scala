...
import pw.byakuren.hudplugin.segments.{AirSegment, BootsDurabilitySegment, ChestplateDurabilitySegment, HUDSegment, HealthSegment, HelmetDurabilitySegment, LeggingDurabilitySegment, TimeSegment}
